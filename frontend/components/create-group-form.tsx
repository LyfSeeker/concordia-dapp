...
export function CreateGroupForm({ onGroupCreated }: CreateGroupFormProps) {
  ...
  return (
    <Card className="max-w-2xl mx-auto bg-concordia-purple/20 border-concordia-light-purple/30 backdrop-blur-sm">
      <CardHeader className="text-center">
        <CardTitle className="text-concordia-pink text-2xl">{"Create New Savings Group"}</CardTitle>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="numMembers" className="text-white">
                  {"Number of Members (2-10, including yourself)"}
                </Label>
                <Input
                  id="numMembers"
                  type="number"
            ...
            <div className="space-y-4">
              ...
              <div className="bg-concordia-light-purple/10 rounded-lg p-4 border border-concordia-light-purple/20 text-sm text-white/70">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-white font-semibold text-sm">{"Security Notice"}</h4>
